...
class ArgParser():
    def __init__(self):
        ...
        self.user_name = os.environ.get("USER", "colab_user")
        ...
        self.parser.add_argument('--test_dataset', type=str, choices=dataset_list, default='rotten',
        ...
        self.parser.add_argument('--training_type', type=str, choices=training_type_list, default='unigen',
        ...
        self.parser.add_argument('--data_path', type=str, default=f'/content/drive/MyDrive/unigen/dataset/amazon_multi_domain',
                                 help='Path to the dataset.')
        self.parser.add_argument('--preprocess_path', type=str, default=f'/content/drive/MyDrive/unigen/preprocessed/{self.proj_name}',
                                 help='Path to the preprocessed dataset.')
        self.parser.add_argument('--model_path', type=str, default=f'/content/drive/MyDrive/unigen/model_final/{self.proj_name}',
                                 help='Path to the model after training.')
        self.parser.add_argument('--checkpoint_path', type=str, default=f'/content/drive/MyDrive/unigen/model_checkpoint/{self.proj_name}')
        self.parser.add_argument('--result_path', type=str, default=f'./results/{self.proj_name}',
                                 help='Path to the result after testing.')
        self.parser.add_argument('--log_path', type=str, default=f'/content/drive/MyDrive/unigen/tensorboard_log/{self.proj_name}',
        ...
        self.parser.add_argument('--gen_prompt', type=str, default=f'gen_movie_p1',
        ...
        self.parser.add_argument('--model_type', type=str, choices=model_type_list, default='tinybert',
        ...
        self.parser.add_argument('--generation_type', type=str, choices=generation_type_list, default='zerogen',
        ...
        self.parser.add_argument("--gen_amount", type=int, default=20000,
        ...
        self.parser.add_argument("--sungen_valid_size", type=int, default=2000,
                                 help="The size of validation set for UniGen/SunGen.")
        self.parser.add_argument("--sungen_train_size", type=int, default=18000,
        ...
        self.parser.add_argument("--sungen_outer_epoch", type=int, default=10,
