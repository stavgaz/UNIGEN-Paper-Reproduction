...
def load_data(args: argparse.Namespace) -> tuple: # (dict, dict, dict, int)
    ...
    if name == 'sst2':
        ...
        if name == 'multi_domain_book':
            dataset = pd.read_csv(os.path.join(args.data_path, 'amazon_multidomain_books.csv'))
        elif name == 'multi_domain_dvd':
            dataset = pd.read_csv(os.path.join(args.data_path, 'amazon_multidomain_dvd.csv'))
        elif name == 'multi_domain_kitchen':
            dataset = pd.read_csv(os.path.join(args.data_path, 'amazon_multidomain_kitchen.csv'))
        elif name == 'multi_domain_electronics':
            dataset = pd.read_csv(os.path.join(args.data_path, 'amazon_multidomain_electronics.csv'))
        num_classes = 2
        ...
        if name == 'amazon_review_fashion':
            file_name = os.path.join(args.data_path, 'AMAZON_FASHION_5.json')
        elif name == 'amazon_review_beauty':
            file_name = os.path.join(args.data_path, 'All_Beauty_5.json')
        elif name == 'amazon_review_appliances':
            file_name = os.path.join(args.data_path, 'Appliances_5.json')
        elif name == 'amazon_review_arts':
            file_name = os.path.join(args.data_path, 'Arts_Crafts_and_Sewing_5.json')
        elif name == 'amazon_review_automotive':
            file_name = os.path.join(args.data_path, 'Automotive_5.json')
        elif name == 'amazon_review_books':
            file_name = os.path.join(args.data_path,  'Books_5.json')
        elif name == 'amazon_review_cds':
            file_name = os.path.join(args.data_path, 'CDs_and_Vinyl_5.json')
        elif name == 'amazon_review_cellphones':
            file_name = os.path.join(args.data_path, 'Cell_Phones_and_Accessories_5.json')
        elif name == 'amazon_review_clothing':
            file_name = os.path.join(args.data_path, 'Clothing_Shoes_and_Jewelry_5.json')
        elif name == 'amazon_review_digitalmusic':
            file_name = os.path.join(args.data_path, 'Digital_Music_5.json')
        elif name == 'amazon_review_electronics':
            file_name = os.path.join(args.data_path, 'Electronics_5.json')
        elif name == 'amazon_review_giftcards':
            file_name = os.path.join(args.data_path, 'Gift_Cards_5.json')
        elif name == 'amazon_review_grocery':
            file_name = os.path.join(args.data_path, 'Grocery_and_Gourmet_Food_5.json')
        elif name == 'amazon_review_home':
            file_name = os.path.join(args.data_path, 'Home_and_Kitchen_5.json')
        elif name == 'amazon_review_industrial':
            file_name = os.path.join(args.data_path, 'Industrial_and_Scientific_5.json')
        elif name == 'amazon_review_kindle':
            file_name = os.path.join(args.data_path, 'Kindle_Store_5.json')
        elif name == 'amazon_review_luxury':
            file_name = os.path.join(args.data_path, 'Luxury_Beauty_5.json')
        elif name == 'amazon_review_magazines':
            file_name = os.path.join(args.data_path, 'Magazine_Subscriptions_5.json')
        elif name == 'amazon_review_movies':
            file_name = os.path.join(args.data_path, 'Movies_and_TV_5.json')
        elif name == 'amazon_review_musicalinstruments':
            file_name = os.path.join(args.data_path, 'Musical_Instruments_5.json')
        elif name == 'amazon_review_officeproducts':
            file_name = os.path.join(args.data_path, 'Office_Products_5.json')
        elif name == 'amazon_review_patio':
            file_name = os.path.join(args.data_path, 'Patio_Lawn_and_Garden_5.json')
        elif name == 'amazon_review_pet':
            file_name = os.path.join(args.data_path, 'Pet_Supplies_5.json')
        elif name == 'amazon_review_primepantry':
            file_name = os.path.join(args.data_path, 'Prime_Pantry_5.json')
        elif name == 'amazon_review_software':
            file_name = os.path.join(args.data_path, 'Software_5.json')
        elif name == 'amazon_review_sports':
            file_name = os.path.join(args.data_path, 'Sports_and_Outdoors_5.json')
        elif name == 'amazon_review_tools':
            file_name = os.path.join(args.data_path, 'Tools_and_Home_Improvement_5.json')
        elif name == 'amazon_review_toys':
            file_name = os.path.join(args.data_path, 'Toys_and_Games_5.json')
        elif name == 'amazon_review_videogames':
            file_name = os.path.join(args.data_path, 'Video_Games_5.json')
